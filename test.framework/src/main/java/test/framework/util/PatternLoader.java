...
public class PatternLoader {
	...
	public static List<Class<? extends TestCaseCommand>> loadCommandPrototypes()
		...
		for (ResourceInfo resourceInfo : resources) {
			...
			if (!resourceName.endsWith(".class"))
				continue;
			if (resourceName.startsWith("org/openqa/") || resourceName.startsWith("org/springframework/")
					|| resourceName.startsWith("java") || resourceName.startsWith("org/apache/")
					|| resourceName.startsWith("com/sun/") || resourceName.startsWith("org/eclipse/")
					|| resourceName.startsWith("org/google/") || resourceName.startsWith("jdk/")
					|| resourceName.startsWith("sun/"))
				continue;
